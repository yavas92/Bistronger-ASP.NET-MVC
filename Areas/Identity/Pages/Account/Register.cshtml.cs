...
/// Abdullah
/// </summary>
namespace Bistronger.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserRole _userRoleManager;
        ...
        public class InputModel
        {
            ...
            public UserRoleType RoleType { get; set; } = UserRoleType.Unknown;
            ...
            [Required(ErrorMessage = "Veld is verplicht.")]
            [StringLength(100, ErrorMessage = "Het wachtwoord moet minstens {2} en max {1} karakters lang zijn.", MinimumLength = 6)]
...
protocol: Request.Scheme);
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Bevestig uw email",
                        $"Account bevestigen: <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'></a>.");

                    _userRoleManager.AssignRoleToUser(user, Input.RoleType);
